...
import com.jozef.recipeapp.Adapter.AdapterPopular;
import com.jozef.recipeapp.Model.ResModel;
import com.jozef.recipeapp.RoomDB.AppDatabase;
import com.jozef.recipeapp.RoomDB.User;
import com.jozef.recipeapp.RoomDB.UserDao;
...
public class HomeActivity extends AppCompatActivity {
    ...
    public void setPopularList() {
        ...
        ImageView img;
        TextView txt, txt2;
        img = findViewById(R.id.popular_img);
        txt = findViewById(R.id.popular_txt);
        txt2 = findViewById(R.id.popular_time);
        AdapterPopular adapter = new AdapterPopular(dataPopular, getApplicationContext(),R.layout.list_design,img,txt,txt2 );
    ...
    private void showBottomSheet() {
        ...
        privayPolicy.setOnClickListener(v ->{
            ...
            intent.setData(Uri.parse(getString(R.string.privacy_policy_html_file)));
            startActivity(intent);
        });
